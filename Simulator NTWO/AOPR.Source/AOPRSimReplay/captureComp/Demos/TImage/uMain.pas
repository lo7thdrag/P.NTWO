...
uses
  Clipbrd, ShellApi, ShlObj, ActiveX, inifiles, uFullscrn, uScreenDelay,
...
begin
  ...
  ScrollBar1.Width := ToolBar4.ClientWidth - PercentItem.Width;
  UpdateControls;
...
begin
  ...
  Fit2.Enabled := PageControl1.PageCount <> 0;
    ...
    try
      ...
      begin
        ...
        begin
          ...
          AExtension := '.bmp';
          AFilename := DocumentsFolder + Format ( 'Capture%d' + AExtension, [ PageControl1.ActivePage.PageIndex + 1 ] );
...
begin
  ...
  begin
    ...
    try
      ...
      // Jpg, GIF and PNG do not have a canvas (needed for rubberbanding and cropping) so convert all images to TBitmap
      if iExt = '.jpg' then
      begin
  ...
  begin
    ...
    begin
      ...
      try
        ...
        try
          AImage.Picture.SaveToFile ( IncludeTrailingPathDelimiter ( DesktopFolder ) + ExtractFilename ( AFileName ) );
        except
          ...
          begin
            ...
            TaskDialog1.Text := 'Error saving file, ' + IncludeTrailingPathDelimiter ( DesktopFolder ) + ExtractFilename (
              AFileName
              );
        ...
        PageControl1.ActivePage.Caption := JustName ( AFileName );
        PageControl1.ActivePage.Hint := AFileName;
  ...
  begin
    ...
    try
      ...
      begin
        ...
        AExtension := ExtractFileExt ( SavePictureDialog1.Filename );
        if Length ( AExtension ) = 0 then
          AExtension := '.jpg';
        Temp := AImage.Picture.Graphic is TJPEGImage;
        if not ( Temp ) and ( AExtension = '.jpg' ) then
        begin

          with TJPEGImage ( AImage.Picture.Graphic ) do
            JPEGNeeded;
      ...
      try
        ...
        begin
          ...
          begin
            ...
            AExtension := '.bmp';
            AFilename := DocumentsFolder + Format ( 'Capture%d', [ PageControl1.ActivePage.PageIndex + 1 ] ) + AExtension;
            PageControl1.ActivePage.Caption := ExtractFileName ( AFilename );
            PageControl1.ActivePage.Hint := AFilename;
...
begin
  ...
  begin
    ...
    Image1.Picture.Bitmap.Assign ( AImage.Picture.Bitmap );
    Image1.Picture.Bitmap.PixelFormat := pf1bit;
    Image1.Transparent := False;
    Image1.Update;
    StatusBar1.Panels [ 5 ].Text := ' Color Depth: RGB1-bit';
...
begin
  ...
  begin
    ...
    Image1.Transparent := False;
    Image1.Update;
    StatusBar1.Panels [ 5 ].Text := ' Color Depth: RGB4-bit';
...
begin
  ...
  begin
    ...
    Image1.Transparent := False;
    Image1.Update;
    StatusBar1.Panels [ 5 ].Text := ' Color Depth: RGB8-bit';
...
begin
  ...
  begin
    ...
    Image1.Transparent := False;
    Image1.Update;
    StatusBar1.Panels [ 5 ].Text := ' Color Depth: RGB15-bit';
...
begin
  ...
  begin
    ...
    Image1.Transparent := False;
    Image1.Update;
    StatusBar1.Panels [ 5 ].Text := ' Color Depth: ARGB16-bit';
...
begin
  ...
  begin
    ...
    Image1.Transparent := False;
    Image1.Update;
    StatusBar1.Panels [ 5 ].Text := ' Color Depth: RGB24-bit';
...
begin
  ...
  begin
    ...
    Image1.Update;
    StatusBar1.Panels [ 5 ].Text := ' Color Depth: ARGB32-bit';
