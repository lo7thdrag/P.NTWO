...
begin
  ...
  with nSet do begin
    ...
    retryconnect := Abs( INIFReadInteger(inif, c_net, 'retry',   20000)); // 10 detik
    sendInterval := Abs( INIFReadInteger(inif, c_net, 'sendinterval', 30000)); // 20 detik
...
begin
  ...
  with gpsSet do begin
    ...
    StartOn := INIFReadBool(inif, c_gps, 'starton', false);
...
//    IniF.WriteBool(c_gps, 'starton', StartOn);
  end;
