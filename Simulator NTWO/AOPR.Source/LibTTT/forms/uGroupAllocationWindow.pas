...
procedure TGroupAllocationWindowForm.EnableButton;
begin
  btnAddMembers.Enabled   := True;
  btnRemoveMembers.Enabled   := True;
  btnAddExternalComm.Enabled   := True;
  btnRemoveExternalComm.Enabled   := True;
end;
